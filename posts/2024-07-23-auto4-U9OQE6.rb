...
然而，尽管用户数量庞大，针对平台使用的评价也呈现出两极分化的趋势。大多数用户对K Health的服务感到满意，特别是在与AI对话后进行线上医疗访问。

当前，约有70%的用户在完成与AI的对话后，选择继续进行线上医疗访问。这一数据表明，K Health的AI系统在初步诊断和用户信任建立方面表现出色。但在TrustPilot和其他一些平台上，部分用户对K Health提出了负面评价，主要集中在在线治疗的局限性。
...
K Health一直以来都在不断收集正负面评价并分析用户反馈，持续改进其平台和服务，以更好地满足用户需求，提升用户体验。用户的互动数据不仅帮助公司优化其AI模型，还为开发新功能和服务提供了宝贵的参考。例如，2020年，K Health从梅奥诊所获得了包括530万患者记录的大型匿名数据集，这些数据帮助公司开发了用于高血压个性化治疗方案的预测算法。
...
04.AI医疗的全球化浪潮
时至今日，AI技术正在不断提高医学研究、诊断和治疗水平，以此带来更好的医疗效果，并不断提高医疗服务的生产力和效率。2022年，人工智能医疗行业的市场规模为151亿美元。随着人们对用AI驱动的解决方案的需求不断增加，在未来几年，全球人工智能医疗市场也将大幅增长，预计在2030年达到惊人的1879.5亿美元。市场的增长还将催生新兴人工智能医疗技术的发展。
